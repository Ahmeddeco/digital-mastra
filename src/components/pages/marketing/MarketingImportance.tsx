...
export default async function MarketingImportance({
	params,
}: {
		...
		<section>
			...
			<div className='flex flex-col gap-6 items-center justify-center'>
				...
				<p className='text-center max-w-5xl'>
					{dict.marketingPage.marketingImportance.p}
				</p>
			</div>
			{/* ---------------------------------- Image --------------------------------- */}
			...
			{/* -------------------------------- Accordion ------------------------------- */}
			{dict.marketingPage.marketingImportance.marketingImportanceAccordion.map(
				({ image, p, title, id }) => (
					<Accordion
						type='single'
						collapsible
