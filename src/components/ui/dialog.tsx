			...
			>
				...
				{showCloseButton && (
					<DialogPrimitive.Close data-slot="dialog-close" asChild>
						<Button variant="outline" className="absolute top-4 right-4 " size="icon-xs">
							<XIcon />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
	return (
		<DialogPrimitive.Title
			...
			className={cn("font-heading text-start text-base leading-none font-medium", className)}
			{...props}
		/>
	)
}
