	...
	return (
		<section className=''>
			...
			<div className='flex flex-col gap-6 items-center justify-center '>
				<h2 className={``}>{dict.DevelopmentPage.developmentServices.h2}</h2>
				<p className='max-w-2xl text-center'>
					{dict.DevelopmentPage.developmentServices.p}
				</p>
			</div>

			{/* -------------------------------- Accordion ------------------------------- */}
			{dict.DevelopmentPage.developmentServices.accordion.map(
				({ image, p, title, value }) => (
					<Accordion
						type='single'
						collapsible
